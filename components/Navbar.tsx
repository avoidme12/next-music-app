        ...
        <>
            <div className='w-full flex justify-between items-center font-semibold'>
                <div className='flex items-center gap-2'>
                    <ArrowLeft onClick={() => navigate(-1)} size={30} className='w-6 bg-black rounded-2xl p-[2px] cursor-pointer'/>
                    <ArrowRight onClick={() => navigate(1)} size={30} className='w-6 bg-black rounded-2xl p-[2px] cursor-pointer'/>
                </div>
                <div className='flex items-center gap-4'>
                    <h1 onClick={() => {window.open("https://www.donationalerts.com/r/avoidme12", "_blank")}}
                       className='bg-black text-white py-1 px-3 rounded-2xl text-[15px] cursor-pointer hover:bg-orange-400 transition-all ease-in duration-300'>Поддержать меня</h1>
                    <h1 onClick={() => {
